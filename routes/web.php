...
<<<<<<< HEAD
Route::resource('bimestre', 'escuela\catalogo\BimestreController'); //REALIZADO EL 11/09
Route::resource('carrera', 'escuela\catalogo\CarreraController'); //REALIZADO EL 11/09
...
Route::resource('gradoSeccion', 'escuela\catalogo\GradoSeccionController'); //REALIZADO EL 12/09
Route::resource('mes','escuela\catalogo\MesController'); //REALIZADO EL 12/09
Route::resource('seccion', 'escuela\catalogo\SeccionController'); //REALIZADO EL 13/09
Route::resource('tipoFondo', 'escuela\catalogo\tipoFondoController'); //REALIZADO EL 13/09
...
Route::resource('alumno', 'escuela\sistema\AlumnoController'); //REALIZADO EL 14/09
Route::resource('alumnoGrado', 'escuela\sistema\alumnoGradoController'); //REALIZADO EL 14/09
Route::resource('catedratico', 'escuela\sistema\CatedraticoController'); //REALIZADO EL 14/09
Route::resource('catedraticoCurso','escuela\sistema\CatedraticoCursoController'); //REALIZADO EL 15/09
Route::resource('catedraticoCurso','escuela\sistema\CatedraticoCursoController'); //REALIZADO EL 15/09
Route::resource('fondo','escuela\sistema\fondoController'); //REALIZADO EL 15/09
Route::resource('nota','escuela\sistema\notaController'); //REALIZADO EL 15/09
Route::resource('inscripcion', 'escuela\sistema\InscripcionController'); //REALIZADO EL 16/09
...
Route::resource('mensualidad', 'escuela\sistema\MensualidadController'); //REALIZADO EL 16/09
Route::resource('pagoCatedratico','escuela\sistema\pagoCatedraticoController'); //REALIZADO EL 17/09
Route::resource('persona','escuela\sistema\PersonaController'); //REALIZADO EL 17/09
Route::resource('municipio','escuela\catalogo\MunicipioController'); //REALIZADO EL 17/09
Route::resource('promedio','escuela\sistema\PromedioController'); //REALIZADO EL 17/09
...
>>>>>>> 06b8f88047a67ff7adf7903dcfc3c0c5d4195f81
