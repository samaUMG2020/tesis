    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header py-4">
          <h3 class="card-title">Reporte de Mensualidades del Año {{ $anio }}</h3>

          <div class="card-tools">
            <form action="{{ route('reporte.mensualidad_view') }}" method="get" role="search">
              {{ csrf_field() }}
              <div class="input-group input-group-sm" style="width: 450px;">
                ...
                @if ($anio && count($errors) == 0)
                    <a class="btn btn-outline-success" href="{{ route('reporte.mensualidad_report', $anio) }}" ><small>Imprimir</small></a>
                @endif
            </form>
          </div>
        </div>
