              ...
              <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-2">
                  <div class="form-group">
                    ...
                    <br>
                    <select name="anio" id="input-anio" class="js-example-basic-single form-control form-control-alternative{{ $errors->has('anio') ? ' is-invalid' : '' }}">
                        <option style="color: black;" value="Año Actual" {{ ('Año Actual' == old('anio', $anio)) ? 'selected' : '' }}>Año Actual</option>
                        <option style="color: black;" value="Próximo Año" {{ ('Próximo Año' == old('anio', $anio)) ? 'selected' : '' }}>Próximo Año</option>
                    </select>
                  </div>
                </div>
              </div>
