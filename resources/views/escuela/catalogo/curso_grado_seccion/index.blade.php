...
@section('content_header')
    <h2>
      Curso Grado Sección
      <a href="{{ route('cursoGS.create') }}" class="btn btn-info">Nuevo</a>       
    </h2>
      ...
      <div class="card">
        <div class="card-header py-4">
          ...
          <div class="card-tools">
            <form action="{{ route('cursoGS.index') }}" method="get" role="search">
              {{ csrf_field() }}
                ...
                <tr>
                  ...
                  <td>
                    <form action="{{ route('cursoGS.destroy', $value) }}" method="post">
                      <a class="btn btn-outline-warning" href="{{ route('cursoGS.edit', $value) }}" ><span class="fa fa-pencil-alt"></span></a>
                      {{csrf_field()}}
