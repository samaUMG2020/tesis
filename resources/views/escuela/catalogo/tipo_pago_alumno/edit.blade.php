  ...
  <div class="row">
    <div class="col-12">
      <div class="card">
        ...
        <div class="card-body">           
            <form method="POST" action="{{ route('tipoPagoAlumno.update', $values->id) }}"  role="form">
              {{ csrf_field() }}
              ...
              <div class="row justify-content-between">
                <a href="{{ route('tipoPagoAlumno.index') }}" class="btn btn-default" >Cancelar</a>
